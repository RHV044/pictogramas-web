          ...
          {pictogramaCargado && (
            ...
            >
              ...
              >
                <CardActionArea
                  onClick={() =>
                    speak({ text: pictograma.keywords.length > 1 ? pictograma.keywords[1].keyword : pictograma.keywords.length > 1 ? pictograma.keywords[1].keyword : pictograma.keywords[0].keyword })
                  }
                >
                  <CardMedia
                    component="img"
